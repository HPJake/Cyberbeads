// ========== MARD 291 COLOR CODE → HEX MAPPING ==========
// Source: https://pindou.skin/colors.html (scraped 2026-06-23)
const MARD_COLORS = {
  // A series
...
// Reverse mapping: HEX → MARD code (for blueprint generation)
const MARD_HEX_TO_CODE = {};
for (const [code, hex] of Object.entries(MARD_COLORS)) {
  MARD_HEX_TO_CODE[hex.toUpperCase()] = code;
}
